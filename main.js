...
class budgetapp{
    constructor(addBudgetBtn,addExpenseBtn,addRevenuBtn,table){
        ...
        this.income = document.querySelector("#revenu-row");
    ...
    addIncome(){
        ...
        /\d/.test(this.revenu_title.value)){
            ...
            this.myClone = this.income.content.cloneNode(true);
            let th = this.myClone.querySelectorAll('th');
            th[0].innerText = this.revenu_title.value;
            th[1].innerText = +this.revenu_price.value;
            this.tbody.appendChild(this.myClone);
        }
